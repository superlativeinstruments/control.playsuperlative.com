...
async function save() {
	...
	await configPort.write(configAddresses.INT_MIDI_CHAN_IN, settings.value.intMidiChannelIn);
	await configPort.write(configAddresses.INT_MIDI_CHAN_OUT, settings.value.intMidiChannelOut);
	await configPort.write(configAddresses.EXT_MIDI_CHAN_IN, settings.value.extMidiChannelIn);
	await configPort.write(configAddresses.EXT_MIDI_CHAN_OUT, settings.value.extMidiChannelOut);
